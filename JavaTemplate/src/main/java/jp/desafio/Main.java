...
import jp.desafio.string.JPFormatter;
import jp.desafio.string.StringFormatter;
...
public class Main {
	...
	public static void main(String[] args) {
        ...
        // Run formatter
        final StringFormatter sf = new JPFormatter();
        StringBuilder outputText = sf.format(text);
